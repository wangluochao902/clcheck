...
parser.add_argument(
    '--eman_path', nargs='+', type=str, help='paths of eman')
parser.add_argument(
...
if __name__ == "__main__":
    ...
    for path in args.eman_path:
        with open(path, 'r') as f:
            eman = f.read()
        translator.translate(eman, save_to_file=True, save_dir=config.EMANDIR, save_to_db=True, overwrite_db_if_exsits=args.overwrite)
